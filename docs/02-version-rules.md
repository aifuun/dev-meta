...
| 顺序 | 文档 | 回答的问题 | 前置依赖 |
|------|------|-----------|----------|
| 1 | `100-schedule.md` | 什么时候做什么？按什么顺序？ | — |
| 2 | `200-spec.md` | 交付什么？怎样算完成？ | schedule |
| 3 | `300-design.md` | 流程如何串联？模块如何分工？ | spec |
| 4 | `400-build.md` | 怎么实现？怎么执行？ | design |
...
| 文件 | 受众 | 回答的问题 | 关键内容 |
|------|------|-----------|---------|
| `100-schedule.md` | PM / Dev | 工作包如何排期？按什么顺序执行？ | 工作包列表、类别、难度、预估工时、验收标准、状态 |
...
- `100-schedule.md` 模板用于快速起草版本工作包排程。
